...
$this->Title->set(__('Επεξεργασία Οδηγού Σπουδών | {0}', h($this->User->fullName($user))));
?>
...
<div class="row">
    <div class="col-lg-3 mb-1" id="actions-sidebar">
        <div class="list-group">
            ...
            <?= $this->Form->postLink(
                __('Διαγραφή'),
                ['action' => 'delete', $studyGuide->id],
                ['confirm' => __('Είστε σίγουροι πώς θέλετε να διαγράψετε αυτόν τον οδηγό σπουδών;'), 'class' => 'list-group-item list-group-item-action']
                )
                ?>
