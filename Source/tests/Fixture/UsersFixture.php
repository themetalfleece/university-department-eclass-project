...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'confirm_link' => ['type' => 'string', 'length' => 38, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'restore_link' => ['type' => 'string', 'length' => 38, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'timezone' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => 'Europe/Athens', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_uk0' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'confirm_link' => 'Lorem ipsum dolor sit amet',
            'restore_link' => 'Lorem ipsum dolor sit amet',
            'confirmed' => 1,
            'role' => 'Lorem ipsum dolor ',
            'timezone' => 'Lorem ipsum dolor sit amet',
            'created' => '2017-01-04 22:23:33',
            'modified' => '2017-01-04 22:23:33'
        ],
    ];
}
